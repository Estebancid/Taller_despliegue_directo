...
# web application at http://Estebanson.pythonanywhere.com/
...
#import sys
#
#path = '/home/Estebanson/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/Estebanson/mysite/mysite/settings.py'
## and your manage.py is is at '/home/Estebanson/mysite/manage.py'
#path = '/home/Estebanson/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
import sys
#
## The "/home/Estebanson" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/Estebanson/myproject"
path = '/home/Estebanson/Taller_despliegue_directo'
if path not in sys.path:
    sys.path.append(path)
#
